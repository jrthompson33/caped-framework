...
sections:
  - title: "Multi-series line chart in Power BI"
    ...
    embedType: image
    embedSrc: "/images/scenario-02-line-chart-01.png"
    embedCaption: "Multi-series line chart of mortality rates by age group in Power BI."
    annotations:
      - text: "multi-series line chart"
        dimension: output
      - text: "\"Year\" on the x-axis and \"Mortality Rate\" on the y-axis"
  ...
  - title: "Rate-of-change chart after data transformation"
    ...
    embedType: image
    embedSrc: "/images/scenario-02-line-chart-02.png"
    embedCaption: "Line chart of mortality rate change since 1968 after transforming the data with Pandas."
    annotations:
      - text: "a new column of \"Mortality rate change (since 1968).\""
        dimension: input
      - text: "Python script to transform the data"
        dimension: input
      - text: "drag-and-drop"
        dimension: expression
      - text: "a line chart"
